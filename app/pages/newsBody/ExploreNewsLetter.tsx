    ...
    return (
        <div className="flex items-center my-28 flex-col mx-5">
            ...
            <div className="flex  justify-center flex-wrap">
                {
                    EXPLORE_ON_PLATFORMS.map(platform=>
                        {
                            return(
                                <button className=" h-min-36px] w-min-[100px] border rounded-[40px] px-[16px] py-[10px] my-3 mx-[10px] text-[rgba(123,143,254,1)] border-[rgba(123,143,254,1)]"> {platform}</button>
                            )
                        })
                }
            </div>
